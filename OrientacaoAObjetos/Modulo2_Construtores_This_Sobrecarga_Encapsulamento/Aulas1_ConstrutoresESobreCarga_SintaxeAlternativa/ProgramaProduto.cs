...
//internal class ProgramaProduto1
//{
...
//        Produto produto = new Produto(nome, preco); /*Aqui é onde utilizamos o construtor*/
//        Produto produto1 = new Produto(); /*Aqui instanciamos sem parâmetros devido a termos um construtor sem parâmetros*/
//        /*Sintaxe alternativa para inicialização de valores,mesmo não tendo nenhum construtor*/
//        Produto produto2 = new Produto { Nome = "TV", Preco = 500.00, Quantidade = 10 };
